...
GitHub – сервис, который позволяет работать удаленно

1. Переходим на github.com
2. Переходим на репозиторий 
3. Нажимаем на code, копируем ссылку
4. Открываем терминал в VSCode
5. Даем команду
**Git clone** *указываем скопированную ссылку*

Появилась папка с названием как на github

Чтобы поменять папку нужно написать команду 
__сd *указать папку*__

Создаем новый репозиторий в github, когда создали аккаунт

После создания внизу будут подсказки, нам нужна команда которая поможет направить наш репозиторий в удаленный

Когда репозитории подружены – достаточно команды git push, чтобы внести изменения в удаленный репозиторий

## Pull request
* Зайти на необходимый репозиторий
* Fork необходимый репозиторий (разветвить)
* Clone этот репозиторий 
* Создаем свою ветку
* Создаем файл README.md или делаем какие то изменения
* Commit 
* Git push – измененный репо отправится на удаленный
* Нажать в удаленном репозитории Compare and pull request